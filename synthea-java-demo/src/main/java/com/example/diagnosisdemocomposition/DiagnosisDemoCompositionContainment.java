...
public class DiagnosisDemoCompositionContainment extends Containment {
  ...
  public ListSelectAqlField<Cluster> EXTENSION = new ListAqlFieldImp<Cluster>(DiagnosisDemoComposition.class, "/context/other_context[at0001]/items[at0002]", "extension", Cluster.class, this);
  ...
  public SelectAqlField<GenderEvaluation> GENDER = new AqlFieldImp<GenderEvaluation>(DiagnosisDemoComposition.class, "/content[openEHR-EHR-EVALUATION.gender.v1]", "gender", GenderEvaluation.class, this);
