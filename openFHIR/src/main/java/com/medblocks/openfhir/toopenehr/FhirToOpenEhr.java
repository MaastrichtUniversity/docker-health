...
//        final boolean bundle = ResourceType.Bundle.name().equals(context.getFhir().getResourceType()); todo: is this always true? with new context mappings there's no more fhir type
    ...
    private JsonObject resolveFhirPaths(final List<FhirToOpenEhrHelper> helpers, final Resource resource) {
        ...
        log.info(gson.toJson(finalFlat));
        ...
        for (Map.Entry<String, List<FhirToOpenEhrHelper>> artifactMapper : byMainArtifact.entrySet()) {
            final String artifact = artifactMapper.getKey();
//            log.info("artifact");
//            log.info(artifact);
...
//                    log.info("handleBundleExtraction");
                    Gson gg = new GsonBuilder().setPrettyPrinting().create();
//                    log.info(gg.toJson(finalFlat));
                } else {
...
//                log.info("setFhirPathValue");
//                Gson gg = new GsonBuilder().setPrettyPrinting().create();
//                log.info(gg.toJson(flatComposition));
//                log.info("thePath");
//                log.info(thePath);
//                log.info("getOpenEhrType");
//                log.info(helper.getOpenEhrType());
